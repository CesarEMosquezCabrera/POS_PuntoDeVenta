...
function busProducto() {
  // Esto creo que tiene que estar en numFactura.js
...
function validarFormulario(){
  ...
  if(numFactura==null || numFactura.length==0){
    $("#panelInfo").before("<span class='text-danger'>LLENE LOS CAMPOS FALTANTES</span><br>");
    return false
...
/*==========
TRANSFORMAR FECHA AL FORMATO ISO 8601
==========*/
...
==========*/
function resgistrarFactura(datos){
  let numFactura=document.getElementById("numFactura").value
